...
const { ScreenIdAlreadyExistsError, SoundNotFoundError } = require('./error')
...
const flattenFont = (font) => {
  const { id, postscriptName: name, characterSize } = font
  return { id, name, characterSize }
}
 ...
 * @return {Array}
 */
const addGetSoundByIdToSounds = (sounds) => {

...
const { checkAreaType, insertAndNormalizeOrder } = require('./util/project-data')
...
class ProjectData {
  ...
  constructArea (area) {
    ...
    const {
      ...
      mimeType, webpPath, fileType, thumbnailPath, imageCropParams, videoCropParams, font
    } = area
    ...
    const result = {
       ...
       * @return {ProjectData} Project data instance.
       */
